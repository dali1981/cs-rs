...
///
/// Only business-intent fields are transferred. Infrastructure fields
/// (`data_source`, `earnings_source`, `data_dir`) are omitted; the caller
/// is responsible for wiring those to the factory separately.
